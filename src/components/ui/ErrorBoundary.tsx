...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    // Class components can't use hooks — read the language from the store
    // imperatively. The crash panel only renders at crash time, so missing a
    // live language switch here is acceptable.
    const tr = (key: string) => translate(useI18n.getState().lang, key);
    return (
